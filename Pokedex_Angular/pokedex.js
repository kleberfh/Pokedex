...
$(document).ready(function() {
	$('.pokesinf').html('<h4> Id: ' + pokemons[p].id + '<h3> Name: ' + pokemons[p].name + '<h2> Type: ' + pokemons[p].type);
	$('.pokesimg').html("<img src='" + pokemons[p].img + "'/>");

	$('.btn-success').click(function(){
		if (p == p) {
			for (p < p.length; p < 0; p++) {
